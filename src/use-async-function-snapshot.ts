...
export default useAsyncFunctionSnapshot

export function useAsyncFunctionSnapshot<
  F extends (...args: any[]) => Promise<Unpacked<ReturnType<F>>>
>(fn: F): AsyncFunctionSnapshot<F> {
...
interface AsyncFunctionSnapshot<F extends AsyncFunction>
  extends State<F>,
    Getters,
    Methods<F> {
  readonly error: any
